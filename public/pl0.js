...
yy: {},
symbols_: {"error":2,"PROGRAMA":3,"LIMPIAR":4,"BLOQUE":5,"PUNTO":6,"EOF":7,"CONSTANTES":8,"VARIABLES":9,"FUNCIONES":10,"STATEMENT":11,"CONST":12,"ID":13,"=":14,"NUMBER":15,"OTRA_CONSTANTE":16,"PUNTOCOMA":17,"COMA":18,"VAR":19,"OTRA_VARIABLE":20,"PROCEDURE":21,"NOMBRE_FUNCION":22,"PARAMETROS":23,"(":24,"OTROS_PARAMETROS":25,")":26,"EXPRESSION":27,"CALL":28,"PARAMETROS_CALL":29,"BEGIN":30,"OTRO_STATEMENT":31,"END":32,"IF":33,"CONDITION":34,"THEN":35,"ELSE":36,"WHILE":37,"DO":38,"OTROS_PARAMETROS_CALL":39,"ODD":40,"COMPARISON":41,"+":42,"-":43,"*":44,"/":45,"$accept":0,"$end":1},
terminals_: {2:"error",6:"PUNTO",7:"EOF",12:"CONST",13:"ID",14:"=",15:"NUMBER",17:"PUNTOCOMA",18:"COMA",19:"VAR",21:"PROCEDURE",24:"(",26:")",28:"CALL",30:"BEGIN",32:"END",33:"IF",35:"THEN",36:"ELSE",37:"WHILE",38:"DO",40:"ODD",41:"COMPARISON",42:"+",43:"-",44:"*",45:"/"},
...
case 4:
          if (symbolTable.vars[$$[$0-4]])
            throw new Error ("Constant "+$$[$0-4]+" defined twice")

          symbolTable.vars[$$[$0-4]] = { type: $$[$0-5], value: $$[$0-2] }
...
case 6:
          if (symbolTable.vars[$$[$0-3]])
            throw new Error ("Constant "+$$[$0-3]+" defined twice")

          symbolTable.vars[$$[$0-3]] = { type: $$[$0-4], value: $$[$0-1] }
...
case 8:
        if (symbolTable.vars[$$[$0-2]]) 
          throw new Error("Var "+$$[$0-2]+" defined twice");
        
        symbolTable.vars[$$[$0-2]] = { type: $$[$0-3], value: "" /* VACIO */ }

        this.$ = [{ type: $$[$0-3], value: $$[$0-2] , declared_in: "RAIZ"}];
        if($$[$0-1]) this.$ = this.$.concat($$[$0-1]);
...
case 10:
          if (symbolTable.vars[$$[$0-1]]) 
            throw new Error("Var "+$$[$0-1]+" defined twice");
        
          symbolTable.vars[$$[$0-1]] = { type: $$[$0-2], value: "" /* VACIO */ }

          this.$ = [{ type: "VAR", value: $$[$0-1], declared_in: "RAIZ" }];
          if($$[$0]) this.$ = this.$.concat($$[$0]);
...
break;
case 12:
          this.$ = [{type: $$[$0-5], id: $$[$0-4].nombreFuncion, parameters: $$[$0-4].parametros, block: $$[$0-2] }];
          getFormerScope();
...
case 14:
        ...
        symbolTable.vars[$$[$0-1]] = { type: "PROCEDURE", name: $$[$0-1], value: $$[$0].length}; 
        ...
        this.$ = {nombreFuncion: $$[$0-1], parametros: $$[$0]};
      
break;
case 15:
          if (symbolTable.vars[$$[$0-2]]) 
            throw new Error("Parameter " +$$[$0-2]+ " is already defined");
            
          symbolTable.vars[$$[$0-2]] = { type: "PARAM", value: "" };
...
case 18:
          if (symbolTable.vars[$$[$0-1]]) 
            throw new Error("Parameter " +$$[$0-1]+ " is already defined");
            
          symbolTable.vars[$$[$0-1]] = { type: "PARAM", value: "" };
...
case 20:
        ...
        if (f && f.type === "VAR") { 
          ...
          this.$ = {type: $$[$0-1], left: {id: $$[$0-2], declared_in: symbolTables[s].name }, right: $$[$0], declared_in: symbolTables[s].name};
           ...
           throw new Error("Symbol "+$$[$0-2]+" not declared, or cannot be modified");
        }
      
break;
case 21:
      var symbol = findSymbol($$[$0-1]);
      var f = symbol[0];
      var s = symbol[1];

      if (f && f.type === "PROCEDURE" && f.value == $$[$0].length) { 
        ...
        throw new Error("Number of arguments incorrect");
         ...
         throw new Error("Symbol "+$$[$0-1]+" not declared as a Procedure");
      }
...
case 27:
          ...
          if(f) {
            this.$ = [{type: 'ID', value: $$[$0-2]}].concat($$[$0-1]);
             ...
             throw new Error($$[$0-2]+" has not been declared yet");
          }
...
case 31:
          ...
          if(f) {
            this.$ = [{type: 'ID', value: $$[$0-1]}].concat($$[$0]);
             ...
             throw new Error($$[$0-1]+" has not been declared yet");
          }
...
break;
case 41:
      if($$[$0] == 0){throw new Error ("Cannot divide by zero")}
      this.$ = $$[$0-2]/$$[$0];
...
case 44:
        ...
        if (f)
          ...
          throw new Error($$[$0]+" has not been declared yet");
